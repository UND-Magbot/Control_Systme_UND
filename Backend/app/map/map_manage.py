...
from app.Database.models import BusinessInfo, FloorInfo, RobotMapInfo, UserInfo, LocationInfo, RouteInfo, WayInfo, MapInitPose
...
@map_manage.delete("/floors/{floor_id}")
...
def _send_init_pose(robot_ip: str, robot_port: int, items: dict):
    ...
    sock.sendto(header + payload, (robot_ip, robot_port))
    sock.close()
