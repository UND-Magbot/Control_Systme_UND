...
const MENU_ITEMS = [
  ...
  { path: "/schedules", icon: "schedule", label: "작업관리", childIds: ["schedule-list", "schedule-insert"] },
  { path: "/robots", icon: "robot", label: "운영관리", childIds: ["robot-list", "place-list", "path-list"] },
  { path: "/mapManagement", icon: "map", label: "맵 관리", childIds: ["map-management"] },
  { path: "/dataManagement", icon: "data", label: "데이터관리", childIds: ["video", "statistics", "log"] },
  { path: "/alerts", icon: "alerts", label: "알림", childIds: ["alert-total", "alert-schedule", "alert-emergency", "alert-robot", "alert-notice"] },
